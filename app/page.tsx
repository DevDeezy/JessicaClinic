        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`w-14 h-14 rounded-2xl bg-${service.color}-100 flex items-center justify-center text-${service.color}-600 mb-6 group-hover:scale-110 transition-transform`}
                >
                  {service.icon}
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-sage-600 text-lg">
                ...
                avaliação. Estamos aqui para ajudá-lo.
              </p>

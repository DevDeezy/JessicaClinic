            ...
            {[
              {
                ...
                description: 'Tratamento de lesões músculo-esqueléticas, fraturas, e reabilitação pós-cirúrgica.',
                color: 'terracotta'
              },
              {
                icon: <Users className="w-7 h-7" />,
                title: 'Fisioterapia Desportiva',
                description: 'Recuperação de atletas, prevenção de lesões e otimização do desempenho desportivo.',
                color: 'sage'
              },
              {
                icon: <Shield className="w-7 h-7" />,
                title: 'Terapia Manual',
                description: 'Técnicas manuais especializadas para alívio da dor e melhoria da mobilidade.',
                color: 'cream'
              },
              {
                icon: <Clock className="w-7 h-7" />,
                title: 'Drenagem Linfática',
                description: 'Tratamento para redução de edemas e melhoria da circulação linfática.',
                color: 'sage'
              },
              {
                icon: <Sparkles className="w-7 h-7" />,
                title: 'Reabilitação Neurológica',
                description: 'Recuperação funcional para pacientes com condições neurológicas.',
                color: 'terracotta'
              },
              {
                icon: <Award className="w-7 h-7" />,
                title: 'Eletroterapia',
                description: 'Uso de correntes elétricas terapêuticas para tratamento da dor e regeneração.',
                color: 'cream'
              },
            ].map((service, index) => (
              <motion.div
                ...
                className={`group p-8 rounded-3xl border-2 border-${service.color}-100 hover:border-${service.color}-200 bg-gradient-to-br from-white to-${service.color}-50 hover:shadow-xl transition-all duration-300 cursor-pointer`}
              >
                <div className={`w-14 h-14 rounded-2xl bg-${service.color}-100 flex items-center justify-center text-${service.color}-600 mb-6 group-hover:scale-110 transition-transform`}>
                  {service.icon}
                </div>
            ...
            {[
              {
                name: 'Ana Rodrigues',
                role: 'Atleta Amadora',
                content: 'Após uma lesão no joelho, a equipa da Jessica ajudou-me a recuperar completamente. Voltei a correr em apenas 3 meses!',
              },
              {
                name: 'Carlos Mendes',
                role: 'Empresário',
                content: 'As dores nas costas que me acompanhavam há anos desapareceram após o tratamento. Profissionais extraordinários!',
              },
              {
                name: 'Sofia Costa',
                role: 'Professora',
                content: 'O atendimento personalizado faz toda a diferença. Sinto-me sempre bem acompanhada e os resultados são visíveis.',
              },

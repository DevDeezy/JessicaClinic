    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div>
          ...
          <p className="text-sage-500 mt-1">Gerencie as suas preferências e configurações</p>
        </div>
          ...
          <div className="md:col-span-3 space-y-6">
            {activeSection === 'profile' && (
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div className="flex items-center gap-6 mb-8">
                  ...
                  <div>
                    <h3 className="font-semibold text-sage-800 text-lg">{session?.user?.name}</h3>
                    <p className="text-sage-500">{session?.user?.email}</p>
                  </div>
                </div>
            ...
            {activeSection === 'schedule' && (
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-sage-700 mb-2">Duração Padrão de Consulta</label>
                    <select
                  ...
                  <div className="flex items-center justify-between p-4 bg-cream-50 rounded-xl">
                    ...
                    <button
                      ...
                      className={`w-12 h-6 rounded-full transition-colors ${
                        settings.reminderEnabled ? 'bg-sage-600' : 'bg-sage-200'
                      }`}
                    >
                    ...
                    {['light', 'dark', 'system'].map((theme) => (
                      ...
                      >
                        <div className={`w-full h-16 rounded-lg mb-3 ${
                          theme === 'light' ? 'bg-cream-100' :
                          theme === 'dark' ? 'bg-sage-800' :
                          'bg-gradient-to-r from-cream-100 to-sage-800'
                        }`} />
            ...
            {activeSection === 'security' && (
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-sage-700 mb-2">Confirmar Nova Palavra-passe</label>
                    <input
                      type="password"
                      placeholder="••••••••"
                      className="w-full px-4 py-3 rounded-xl border border-sage-200 focus:border-sage-400 focus:ring-2 focus:ring-sage-100 outline-none"
            ...
            <div className="flex justify-end">
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex items-center gap-2 px-6 py-3 bg-sage-700 text-white rounded-xl font-medium hover:bg-sage-800 transition-all disabled:opacity-50"
              >

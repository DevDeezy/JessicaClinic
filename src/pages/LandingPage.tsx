...
export default function LandingPage() {
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="font-display text-2xl font-semibold text-sage-800">Jessica</span>
            </Link>
            
            <div className="hidden md:flex items-center gap-8">
              <a href="#servicos" className="text-sage-600 hover:text-sage-800 transition-colors">Serviços</a>
              <a href="#sobre" className="text-sage-600 hover:text-sage-800 transition-colors">Sobre Nós</a>
              <a href="#testemunhos" className="text-sage-600 hover:text-sage-800 transition-colors">Testemunhos</a>
              <a href="#contacto" className="text-sage-600 hover:text-sage-800 transition-colors">Contacto</a>
            </div>
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
          <motion.div 
            ...
            className="space-y-8"
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 bg-sage-100 rounded-full">
              <Sparkles className="w-4 h-4 text-terracotta-500" />
              <span className="text-sm font-medium text-sage-700">Cuidado personalizado para si</span>
            </motion.div>
            
            <motion.h1 variants={fadeInUp} className="font-display text-5xl lg:text-7xl font-semibold leading-tight">
              O seu caminho para uma{' '}
              <span className="gradient-text">vida sem dor</span>
            </motion.h1>
            
            <motion.p variants={fadeInUp} className="text-lg text-sage-600 max-w-xl leading-relaxed">
              Na Jessica Fisioterapia, combinamos técnicas avançadas com um atendimento 
              humanizado para ajudá-lo a recuperar a sua qualidade de vida.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex items-center gap-8 pt-4">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-sage-300 to-sage-500 border-2 border-white" />
                  ))}
                </div>
          ...
          >
            <div className="relative aspect-square rounded-3xl bg-gradient-to-br from-sage-100 to-cream-100 p-8">
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-sage-800">Consulta Marcada</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-sage-800">98% Satisfação</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-sage-600 text-lg">
              Oferecemos uma gama completa de serviços de fisioterapia adaptados às suas necessidades específicas.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <Heart className="w-7 h-7" />, title: 'Fisioterapia Ortopédica', description: 'Tratamento de lesões músculo-esqueléticas, fraturas, e reabilitação pós-cirúrgica.' },
              { icon: <Users className="w-7 h-7" />, title: 'Fisioterapia Desportiva', description: 'Recuperação de atletas, prevenção de lesões e otimização do desempenho desportivo.' },
              { icon: <Shield className="w-7 h-7" />, title: 'Terapia Manual', description: 'Técnicas manuais especializadas para alívio da dor e melhoria da mobilidade.' },
              { icon: <Clock className="w-7 h-7" />, title: 'Drenagem Linfática', description: 'Tratamento para redução de edemas e melhoria da circulação linfática.' },
              { icon: <Sparkles className="w-7 h-7" />, title: 'Reabilitação Neurológica', description: 'Recuperação funcional para pacientes com condições neurológicas.' },
              { icon: <Award className="w-7 h-7" />, title: 'Eletroterapia', description: 'Uso de correntes elétricas terapêuticas para tratamento da dor e regeneração.' },
            ].map((service, index) => (
              <motion.div
                key={service.title}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <h3 className="font-display text-xl font-semibold mb-3 text-sage-800">{service.title}</h3>
      ...
      {/* About Section */}
      <section id="sobre" className="py-24 bg-sage-800 text-white relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-sage-200 text-lg leading-relaxed">
                A nossa clínica foi fundada com a missão de proporcionar cuidados de fisioterapia 
                de excelência, combinando conhecimento científico avançado com um atendimento 
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={stat.label} className="p-6 bg-sage-700/50 rounded-2xl">
                    <p className="font-display text-3xl font-bold text-terracotta-400">{stat.number}</p>
              ...
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-sage-700 to-sage-600 p-8 relative">
                ...
                <div className="relative z-10 w-full h-full rounded-2xl bg-sage-500/30 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-xl font-semibold">Excelência em Fisioterapia</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section id="testemunhos" className="py-24 bg-cream-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Ana Rodrigues', role: 'Atleta Amadora', content: 'Após uma lesão no joelho, a equipa da Jessica ajudou-me a recuperar completamente. Voltei a correr em apenas 3 meses!' },
              { name: 'Carlos Mendes', role: 'Empresário', content: 'As dores nas costas que me acompanhavam há anos desapareceram após o tratamento. Profissionais extraordinários!' },
              { name: 'Sofia Costa', role: 'Professora', content: 'O atendimento personalizado faz toda a diferença. Sinto-me sempre bem acompanhada e os resultados são visíveis.' },
              ...
              >
                ...
                <p className="text-sage-700 mb-6 leading-relaxed">"{testimonial.content}"</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-sage-600 text-lg">
                Entre em contacto connosco para agendar a sua consulta de avaliação.
              </p>

              <div className="space-y-6">
                {[
                  { icon: <Phone className="w-6 h-6" />, label: 'Telefone', value: '+351 912 345 678' },
                  { icon: <Mail className="w-6 h-6" />, label: 'Email', value: 'geral@jessica.pt' },
                  { icon: <MapPin className="w-6 h-6" />, label: 'Morada', value: 'Rua da Saúde, 123, Lisboa' },
                  { icon: <Clock className="w-6 h-6" />, label: 'Horário', value: 'Seg-Sex: 9h-20h | Sáb: 9h-13h' },
                ].map((item) => (
                  <div key={item.label} className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-sage-800">{item.value}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            >
              <form className="bg-cream-50 p-8 rounded-3xl space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-sage-700 mb-2">Mensagem</label>
                  <textarea
                    rows={4}
      ...
      <footer className="bg-sage-900 text-sage-200 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="space-y-4">
              <Link to="/" className="flex items-center gap-3">
                ...
                <span className="font-display text-2xl font-semibold text-white">Jessica</span>
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-white transition-colors">Fisioterapia Ortopédica</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Fisioterapia Desportiva</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Terapia Manual</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Reabilitação</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-sage-800 pt-8 text-center text-sage-400">
            <p>© {new Date().getFullYear()} Jessica Fisioterapia. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>

        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10">
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="font-display text-3xl font-semibold text-sage-800">
                Jessica
              </span>
            </Link>
            <h1 className="text-2xl font-semibold text-sage-800 mb-2">
              Bem-vindo de volta
            </h1>
          ...
          <div className="mt-6 text-center text-sm text-sage-600">
            ...
            <Link
              to="/registar"
              className="text-sage-700 font-semibold hover:text-sage-900"
            >
              Criar conta
            </Link>
          </div>
